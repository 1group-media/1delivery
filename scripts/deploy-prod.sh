...
SERVICE_NAME="onedelivery-prod"
REGION="us-central1"

echo "🚀 Deploying 1delivery to Production Fleet ($PROJECT_ID / $SERVICE_NAME)..."
...
echo "✅ Production deployment complete for 1delivery: https://delivery.1group.media"
